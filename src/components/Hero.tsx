  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white dark:bg-gradient-to-br dark:from-gray-950 dark:to-gray-900 pt-20 transition-colors duration-300">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 left-1/4 w-32 h-32 dark:opacity-5 opacity-3">
          <Lightbulb className="w-full h-full text-blue-500 animate-pulse" style={{ animationDelay: '0.5s' }} />
        </div>

        <div className="absolute bottom-1/3 right-1/4 w-24 h-24 dark:opacity-5 opacity-3">
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-gradient-to-r from-blue-600 to-green-500 rounded-full mb-6 sm:mb-8"
        >
          <Sparkles className="w-4 h-4 text-white flex-shrink-0" />
          <span className="text-xs sm:text-sm font-medium text-white">
            BulbFlux • Digital Marketing Consulting
          </span>
        </motion.div>
        ...
        >
          Consultoria de Digital Marketing para{' '}
        ...
        >
          Desenvolvo estratégias digitais e funnels de alta performance que transformam leads em
          receita consistente — mensal e anual — para negócios online e locais.
        </motion.p>
        ...
        >
          Ideal para empresas que já faturam 5.000–10.000€+/mês e querem escalar de forma sustentável.
        </motion.p>
